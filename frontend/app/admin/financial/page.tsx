    ...
    <div className="p-8 max-w-[1400px] mx-auto w-full bg-[#f8f9fa] min-h-[calc(100vh-64px)] font-sans">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col">
        ...
        <div className="p-5 border-b border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
           ...
           <div className="flex gap-3">
              ...
              <div className="relative">
                <input type="text" placeholder="Search transactions..." className="bg-[#f8f9fa] border border-slate-200 rounded-lg px-4 py-2 text-xs font-semibold focus:outline-none focus:ring-1 focus:ring-slate-300 w-64" />
              </div>
           </div>
        </div>
        ...
        <div className="p-4 border-t border-slate-100 flex items-center justify-between">
           <p className="text-xs font-semibold text-slate-500">Showing 1 to 5 of 2,450 entries</p>
